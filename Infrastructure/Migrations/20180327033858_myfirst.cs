    ...
    public partial class myfirst : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    F_Id = table.Column<Guid>(nullable: false, defaultValueSql: "newid()"),
                    ...
                    F_LastModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "GetUtcDate()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    F_TotalDue = table.Column<decimal>(nullable: false, computedColumnSql: "(isnull(([F_SubTotal]+[F_TaxAmt]),(0.0)))"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    F_Id = table.Column<Guid>(nullable: false, defaultValueSql: "newid()"),
                    F_LastModifiedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "GetUtcDate()"),
                    F_LineTotal = table.Column<decimal>(nullable: false, computedColumnSql: "(isnull(([F_Price]*[F_Quantity]),(0.0)))"),
                    F_Price = table.Column<decimal>(nullable: false),
                    F_ProductId = table.Column<Guid>(nullable: false),
                    F_Quantity = table.Column<float>(nullable: false),
                    F_SalesOrderId = table.Column<Guid>(nullable: false),
